  ...
  return (
    <>
      ...
      <p id="projectOneText">
        ...
        image is transmitted to a remote server which processes the visual data
        by performming semantic segmentation. The server identifies and
        ...
        and sent back to the user, the user's perspect perspective shifts from P
        <span style={{ fontSize: "14px", fontWeight: "bold" }}>1</span> to P
        ...
        transformation, specifically a projective transformation (also known as
        homography), to adjust the virtual content. This transformation
        ...
        To evaluate the effectiveness of our homography-based estimation method,
        we placed the VR headset on a tripod and continuously captured frames
        along with their corresponding poses. The experimental setup included a
        scene containing five Aruco codes. During the testing, the headset
        remained stationary at a distance of 0.75 meters from the Aruco code
        markers, while we either rotated the headset horizontally or translated
        the tripod along the x-axis. By using only the pose information and not
        the image data, we employed the homography method to predict the
        locations of the Aruco codes in subsequent frames. In the following
        image, you can see the result along with the corresponding camera
        trajectory. The results compare the predicted points without any
        compensation to the points when homography was used for compensation,
